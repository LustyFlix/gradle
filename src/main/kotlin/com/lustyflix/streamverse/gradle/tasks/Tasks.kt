...
import com.lustyflix.streamverse.gradle.entities.PluginManifest
import com.lustyflix.streamverse.gradle.makeManifest
...
const val TASK_GROUP = "streamverse"
    ...
    project.afterEvaluate {
        val make = project.tasks.register("make", Zip::class.java) {
            ...
            it.doLast { task ->
                ...
                task.logger.lifecycle("Made Streamverse package at ${task.outputs.files.singleFile}")
            }
        }
